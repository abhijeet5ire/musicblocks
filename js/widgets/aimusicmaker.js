...
class AIMusicMaker {
    ...
    init(activity) {
        ...
        let iconSize = AIMusicMaker.ICONSIZE * this._cellScale;
        ...
        // cell.style.width = AIMusicMaker.BUTTONSIZE * this._cellScale*2 + "px";
        ...
        for (const turtle of this.activity.turtles.turtleList) {
            ...
            this.widgetWindow.onmaximize = () => {
                ...
                cell.style.fontSize =
                    Math.floor(this._cellScale * AIMusicMaker.FONTSCALEFACTOR) * 0.9 + "%";
                if (!this.isMaximized) {
                    cell.style.width = "212.5px";
                }
            };
    ...
    updateAll() {
        ...
        this.activity.logo.updatingAIMusicMaker = true;
        ...
        for (const turtle of this.activity.turtles.turtleList) {
            ...
            let i = 0;
            for (const statusField of this.activity.logo.statusFields) {
                saveStatus = this.activity.logo.inAIMusicMaker;
                this.activity.logo.inAIMusicMaker = false;
                ...
                this.activity.logo.inAIMusicMaker = saveStatus;
        ...
        this.activity.logo.updatingAIMusicMaker = false;
    }
}
